...
```
  ...
  cds_new = compress_lineage_v3(cds_new, "OL", N = 500, cl = cl)
  cds_new = compress_lineage_v3(cds_new, "AST_FB", N = 500, cl = cl)
  cds_new = compress_lineage_v3(cds_new, "AST_PP", N = 500, cl = cl)
```

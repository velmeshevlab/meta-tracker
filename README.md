...
Often, trajectories generated by monocle3 do not pass through cells and clusters in a biologically meaningful way. We can use an interactive browser to modify the graph.
```
